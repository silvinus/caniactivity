...
{
    /// <inheritdoc />
    public partial class v001_add_mysql_migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    RegisteredById = table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandlerId = table.Column<string>(type: "varchar(255)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppointmentsId = table.Column<Guid>(type: "char(36)", nullable: false),
                    DogsId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
